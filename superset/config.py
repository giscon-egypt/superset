...
# THIS IS WHERE THE KEYCLOAK CONFIGURATION CAN BE SET UP
# CURRENTLY IT HAS AUTH_TYPE = AUTH_DB AND THIS IS THE DEFAULT DB CONFIGURATION SUCH AS THE ONE USED
# TO EMBED CURRENTLY

AUTH_TYPE = AUTH_DB
#LOGOUT_REDIRECT_URL='https://sso.giscon.dev/realms/Superset-Integration-Test/protocol/openid-connect/logout'
...
#        'remote_app': {
            ...
            #            'api_base_url': 'https://sso.giscon.dev/auth/admin/master/console/#/realms/Superset-Integration-Test'
#        },
        #}
    #]
